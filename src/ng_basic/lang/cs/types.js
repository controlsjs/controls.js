...
ngc_Lang['cs']['time_am_pm']                = ["dop.","odp."];
...
ngc_Lang['cs']['calendar_months_formating'] = ["ledna","února","března","dubna","května","června","července","srpna","září","října","listopadu","prosince"];
...
ngc_Lang['cs']['calendar_days_formating']   = ngc_Lang['cs']['calendar_days'];

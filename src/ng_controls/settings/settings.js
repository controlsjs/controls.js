...
(function(window) {
   ...
   */
  window.ngSettings = function(id, options)
  {
    if(typeof id === 'undefined')
    {
      window.ngSettingsLastID++;
      id = 'ngSettings'+window.ngSettingsLastID;
    }
    this.changed = false;
    this.update_cnt = false;
    this.save_timer = null;
    window.ngSettingsByID[id]=this;
    this.SettingsID = id;
    this.Settings = {};
    ...
    */
    ...
    if(window.ngOnSettingsCreated) window.ngOnSettingsCreated(this);
  }
})(window);

...
ngc_Lang['en']['viewmodel_err_type_decimal']   = 'Value must be a decimal number.';
ngc_Lang['en']['viewmodel_err_type_string']    = 'Value must be a string.';
ngc_Lang['en']['viewmodel_err_type_datetime']  = 'Value must be date and time.';
ngc_Lang['en']['viewmodel_err_type_date']      = 'Value must be a date.';
ngc_Lang['en']['viewmodel_err_type_time']      = 'Value must be a time.';
ngc_Lang['en']['viewmodel_err_type_array']     = 'Value must be an array.';
ngc_Lang['en']['viewmodel_err_empty']          = 'Value required.';
ngc_Lang['en']['viewmodel_err_min']            = 'Value must be greater or equal to %s.';
ngc_Lang['en']['viewmodel_err_min_novalue']    = 'Value is lower than allowed limit.';
ngc_Lang['en']['viewmodel_err_min_array']      = 'Number of items must be greater or equal to %d.';
ngc_Lang['en']['viewmodel_err_max']            = 'Value must be lower or equal to %s.';
ngc_Lang['en']['viewmodel_err_max_novalue']    = 'Value is higher than allowed limit.';
ngc_Lang['en']['viewmodel_err_max_array']      = 'Number of items must lower or equal to %d.';
...
ngc_Lang['cz']['viewmodel_err_type_decimal']   = 'Hodnota musí být desetinné číslo.';
ngc_Lang['cz']['viewmodel_err_type_string']    = 'Hodnota musí být řetězec.';
ngc_Lang['cz']['viewmodel_err_type_datetime']  = 'Hodnota musí být datum a čas.';
ngc_Lang['cz']['viewmodel_err_type_date']      = 'Hodnota musí být datum.';
ngc_Lang['cz']['viewmodel_err_type_time']      = 'Hodnota musí být čas.';
ngc_Lang['cz']['viewmodel_err_type_array']     = 'Hodnota musí být pole.';
ngc_Lang['cz']['viewmodel_err_empty']          = 'Hodnotu je nutné vyplnit.';
ngc_Lang['cz']['viewmodel_err_min']            = 'Hodnota musí být větší nebo rovna %s.';
ngc_Lang['cz']['viewmodel_err_min_novalue']    = 'Hodnota je nižší než je povolený limit.';
ngc_Lang['cz']['viewmodel_err_min_array']      = 'Počet položek musí být větší nebo rovno %d.';
ngc_Lang['cz']['viewmodel_err_max']            = 'Hodnota musí být menší nebo rovna %s.';
ngc_Lang['cz']['viewmodel_err_max_novalue']    = 'Hodnota je vyšší než je povolený limit.';
ngc_Lang['cz']['viewmodel_err_max_array']      = 'Počet položek musí být menší nebo rovno %d.';
...
ngc_Lang['sk']['viewmodel_err_type']           = 'Nesprávny typ hodnoty.';
ngc_Lang['sk']['viewmodel_err_type_bool']      = 'Hodnota musí byť áno (1) alebo nie (0).';
ngc_Lang['sk']['viewmodel_err_type_integer']   = 'Hodnota musí byť celé číslo.';
ngc_Lang['sk']['viewmodel_err_type_decimal']   = 'Hodnota musí byť desatinné číslo.';
ngc_Lang['sk']['viewmodel_err_type_string']    = 'Hodnota musí byť reťazec.';
ngc_Lang['sk']['viewmodel_err_type_datetime']  = 'Hodnota musí byť dátum a čas.';
ngc_Lang['sk']['viewmodel_err_type_date']      = 'Hodnota musí byť dátum.';
ngc_Lang['sk']['viewmodel_err_type_time']      = 'Hodnota musí byť čas.';
ngc_Lang['sk']['viewmodel_err_type_array']     = 'Hodnota musí byť pole.';
ngc_Lang['sk']['viewmodel_err_empty']          = 'Hodnotu je nutné vyplniť.';
ngc_Lang['sk']['viewmodel_err_min']            = 'Hodnota musí být väčšia alebo rovná %s.';
ngc_Lang['sk']['viewmodel_err_min_array']      = 'Počet položiek musí byť väčší alebo rovný %d.';
ngc_Lang['sk']['viewmodel_err_min_novalue']    = 'Hodnota je nižšia ako je povolený limit.';
ngc_Lang['sk']['viewmodel_err_max']            = 'Hodnota musí býť menšia alebo rovná %s.';
ngc_Lang['sk']['viewmodel_err_max_novalue']    = 'Hodnota je vyššia ako je povolený limit.';
ngc_Lang['sk']['viewmodel_err_max_array']      = 'Počet položiek musí byť menší alebo rovný %d.'; 

...
ngc_Lang['en']['dbviewmodel_err_exists']='Error: Record already exists.';
...
ngc_Lang['en']['dbviewmodel_err_cmd_load']='Request to load record data failed (%s).';
ngc_Lang['en']['dbviewmodel_err_cmd_insert']='Request to insert new record failed (%s).';
ngc_Lang['en']['dbviewmodel_err_cmd_update']='Request to update record failed (%s).';
ngc_Lang['en']['dbviewmodel_err_cmd_delete']='Request to delete record failed (%s).';

...
ngc_Lang['sk']['dbviewmodel_err_exists']='Chyba: Záznam už existuje.';
...
ngc_Lang['sk']['dbviewmodel_err_cmd_load']='Žiadosť o načítanie údajov záznamu zlyhala (%s).';
ngc_Lang['sk']['dbviewmodel_err_cmd_insert']='Žiadosť o vloženie nového záznamu zlyhala (%s).';
ngc_Lang['sk']['dbviewmodel_err_cmd_update']='Žiadosť o aktualizáciu záznamu zlyhala (%s).';
ngc_Lang['sk']['dbviewmodel_err_cmd_delete']='Žiadosť o vymazanie záznamu zlyhala (%s).';

      ...
      return {
        ...
        Properties: ng_diProperties({
          "Data": {
            ...
            "LeftDef": ng_diControl('ngEdit', null, { Level: 'advanced' }, { InheritedFrom: 'ngEdit' }),
            "EditDef": ng_diControl('ngEdit', null, { Level: 'advanced' }, { InheritedFrom: 'ngEdit' }),
            "StaticDef": ng_diControl('ngEdit', null, { Level: 'advanced' }, { InheritedFrom: 'ngEdit' }),
            "RightDef": ng_diControl('ngEdit', null, { Level: 'advanced' }, { InheritedFrom: 'ngEdit' }),

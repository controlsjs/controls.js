    ...
    var types = [
      ...
      // ngLayoutConstraints
      {
        ...
        Options: {
          Add: false,
          ObjectProperties: {
            "LtoR": ng_diMixed(['ngLayoutConstraintRef', ng_diArrayOf(ng_diType('ngLayoutConstraintRef', { Level: 'basic'}))], { Level: 'basic', Order: 0.5, DisplayName: 'Left as right side of (LtoR)' }),
            "LtoRMargin": ng_diMixed(['bounds','ngLayoutConstraintGuideRef'], { Level: 'basic', Order: 0.501, DisplayName: 'Left as right side with margin (LtoRMargin)' }),
            "LtoL": ng_diMixed(['ngLayoutConstraintRef', ng_diArrayOf(ng_diType('ngLayoutConstraintRef', { Level: 'basic'}))], { Level: 'basic', Order: 0.502, DisplayName: 'Left as left side of (LtoL)' }),
            "LtoLMargin": ng_diMixed(['bounds','ngLayoutConstraintGuideRef'], { Level: 'basic', Order: 0.503, DisplayName: 'Left as left side with margin (LtoLMargin)' }),
            "TtoB": ng_diMixed(['ngLayoutConstraintRef', ng_diArrayOf(ng_diType('ngLayoutConstraintRef', { Level: 'basic'}))], { Level: 'basic', Order: 0.504, DisplayName: 'Top as bottom side of (TtoB)' }),
            "TtoBMargin": ng_diMixed(['bounds','ngLayoutConstraintGuideRef'], { Level: 'basic', Order: 0.505, DisplayName: 'Top as bottom side with margin (TtoBMargin)' }),
            "TtoT": ng_diMixed(['ngLayoutConstraintRef', ng_diArrayOf(ng_diType('ngLayoutConstraintRef', { Level: 'basic'}))], { Level: 'basic', Order: 0.506, DisplayName: 'Top as top side of (TtoT)' }),
            "TtoTMargin": ng_diMixed(['bounds','ngLayoutConstraintGuideRef'], { Level: 'basic', Order: 0.507, DisplayName: 'Top as top side with margin (TtoTMargin)' }),
            "RtoL": ng_diMixed(['ngLayoutConstraintRef', ng_diArrayOf(ng_diType('ngLayoutConstraintRef', { Level: 'basic'}))], { Level: 'basic', Order: 0.508, DisplayName: 'Right as left side of (RtoL)' }),
            "RtoLMargin": ng_diMixed(['bounds','ngLayoutConstraintGuideRef'], { Level: 'basic', Order: 0.509, DisplayName: 'Right as left side with margin (RtoLMargin)' }),
            "RtoR": ng_diMixed(['ngLayoutConstraintRef', ng_diArrayOf(ng_diType('ngLayoutConstraintRef', { Level: 'basic'}))], { Level: 'basic', Order: 0.510, DisplayName: 'Right as right side of (RtoR)' }),
            "RtoRMargin": ng_diMixed(['bounds','ngLayoutConstraintGuideRef'], { Level: 'basic', Order: 0.511, DisplayName: 'Right as right side with margin (RtoRMargin)' }),
            "BtoT": ng_diMixed(['ngLayoutConstraintRef', ng_diArrayOf(ng_diType('ngLayoutConstraintRef', { Level: 'basic'}))], { Level: 'basic', Order: 0.512, DisplayName: 'Bottom as top side of (BtoT)' }),
            "BtoTMargin": ng_diMixed(['bounds','ngLayoutConstraintGuideRef'], { Level: 'basic', Order: 0.513, DisplayName: 'Bottom as top side with margin (BtoTMargin)' }),
            "BtoB": ng_diMixed(['ngLayoutConstraintRef', ng_diArrayOf(ng_diType('ngLayoutConstraintRef', { Level: 'basic'}))], { Level: 'basic', Order: 0.514, DisplayName: 'Bottom as bottom side of (BtoB)' }),
            "BtoBMargin": ng_diMixed(['bounds','ngLayoutConstraintGuideRef'], { Level: 'basic', Order: 0.515, DisplayName: 'Bottom as bottom side with margin (BtoBMargin)' }),

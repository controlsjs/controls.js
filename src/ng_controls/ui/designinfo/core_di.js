      ...
      return {
        ...
        Properties: ng_diProperties({
          ...
          "Data": {
            ...
            "AutoComplete": ng_diStringValues('off', ['','off','on','name','username','current-password','new-password','one-time-code','email','tel','shipping', 'billing','home','work','mobile','fax','honorific-prefix','given-name','additional-name','family-name','honorific-suffix','nickname','organization-title','organization','street-address','address-line1','address-line2','address-line3','address-level4','address-level3','address-level2','address-level1','country','country-name','postal-code','cc-name','cc-given-name','cc-additional-name','cc-family-name','cc-number','cc-exp','cc-exp-month','cc-exp-year','cc-csc','cc-type','transaction-currency','transaction-amount','language','bday','bday-day','bday-month','bday-year','sex','url','photo','pager','tel-country-code','tel-national','tel-area-code','tel-local','tel-local-prefix','tel-local-suffix','tel-extension','impp'], { Level: 'basic' }, { Editor: 'ngfeEditor_DropDown' }),
            "InputMode": ng_diStringValues('', ['','none','text','tel','url','email','numeric','decimal','search'], { Level: 'basic' }),
            "ngAlt":  { Level: 'advanced' },
            "ngAltD": { Level: 'basic' },
            "Alt": ng_diString('', { Level: 'basic' }),

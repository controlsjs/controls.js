...
ngc_Lang['sk']['ngfup_Error_Size_Num']          = 'Bola prekročená maximálna veľkosť súboru (%s).';
ngc_Lang['sk']['ngfup_Error_Extension']         = 'Tento typ súboru nie je povolený.';
ngc_Lang['sk']['ngfup_Error_Extension_Info']    = 'Tento typ súboru nie je povolený. Povolené typy: %s.';
ngc_Lang['cs']['ngfup_Error_AllowedExtensions'] = 'Povolené typy súborov: %s.';
ngc_Lang['sk']['ngfup_Error_MaxFiles']          = 'Bol prekročený maximálny počet súborov.';
ngc_Lang['sk']['ngfup_Error_MaxFiles_Num']      = 'Bol prekročený maximálny počet súborov (%s).';
ngc_Lang['sk']['ngfup_Error_MaxBatch']          = 'Veľkosť dávky bola prekročená.';
ngc_Lang['sk']['ngfup_Error_MaxBatch_Num']      = 'Veľkosť dávky bola prekročená (%s).';

...
ngc_Lang['en']['ngfup_Error_Size_Num']          = 'File size has been exceeded (%s).';
ngc_Lang['en']['ngfup_Error_Extension']         = 'This file type is not allowed.';
ngc_Lang['en']['ngfup_Error_Extension_Info']    = 'This file type is not allowed. Allowed types: %s.';
ngc_Lang['en']['ngfup_Error_AllowedExtensions'] = 'Allowed file types: %s.';
ngc_Lang['en']['ngfup_Error_MaxFiles']          = 'The maximum number of files has been exceeded.';
ngc_Lang['en']['ngfup_Error_MaxFiles_Num']      = 'The maximum number of files has been exceeded (%d).';
ngc_Lang['en']['ngfup_Error_MaxBatch']          = 'Batch size has been exceeded.';
ngc_Lang['en']['ngfup_Error_MaxBatch_Num']      = 'Batch size has been exceeded (%s).';
